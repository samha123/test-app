                        ...
                        <tbody>
                            ...
                            @foreach ($orderDetails['items'] as $orderItem)
                                <tr> @if($orderItem['product'] ==null)
                                  ...
                                  @else
                                  <td>{{ $orderItem['product'] }} @if( $orderItem['color']) ({{$orderItem['color']}} )@endif @if( $orderItem['sizes'])(Size: {{ $orderItem['sizes'] }})@endif</td>
                                    <td>{{ $orderItem['qty'] }}</td>
                                  <td>{{ $orderItem['product_amount'] }}</td>
                                    
                                   <td>₹{{number_format( ($orderItem['product_amount'] + $orderItem['cer_amount'] + $orderItem['et_amount']) * $orderItem['qty']) }}</td>
                                  @endif
